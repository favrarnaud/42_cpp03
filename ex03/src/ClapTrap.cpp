...
ClapTrap::ClapTrap(std::string name)
{
    ...
    this->energy = 10;
    this->damage = 0;
    std::cout << "[ClapTrap] " << name << " fait son entrée !" << std::endl;
}
...
ClapTrap::~ClapTrap()
{
    std::cout << "[ClapTrap] " << this->name << " nous fait ces adieux !" << std::endl;
}
...
{
    std::cout << "ce petit " << name << " ce couvre d'une merveilleuse aura bleu et recupere " << amount << " point d'energie !" << std::endl;
    this->energy += amount;
}